...
<div class="container">
   ...
   <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="${pageContext.request.contextPath}/resources/images/img 2.jpg" />
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                    <!-- Datos del vendedor y titulo del producto -->
                    <h3>Women printed black anarkali kurta </h3>    
                    ...
                    <div class="section" style="padding-bottom:5px;">
                        <h6 class="title-attr"><small>Size</small></h6>    
                         ...
                         <div> 
                        <br><br><br> <div class="attr2">40</div>
                        </div> 
                    </div>   
   ...
   <div class="col-xs-9">
                    <ul class="menu-items">
                        ...
                        <li>Women printed black anarkali kurta</li>
