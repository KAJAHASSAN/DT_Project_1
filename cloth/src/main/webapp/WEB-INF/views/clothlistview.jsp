             ...
             <div class="panel-heading">
               <div class="row">
                 <div class="col col-xs-6">
                   <h3 class="panel-title">Cloth list</h3>
                 </div>
               ...
               <table class="table table-striped table-bordered table-list">
                 ...
                 <tbody>
                         ...
                         <td>
                             ...
                             <a class="btn btn-default" href="cloth_edit?id=${p.id}"><em class="fa fa-pencil"></em></a>
                             <a class="btn btn-danger" href="cloth_delete?id=${p.id}"><em class="fa fa-trash"></em></a>
                           </td>
