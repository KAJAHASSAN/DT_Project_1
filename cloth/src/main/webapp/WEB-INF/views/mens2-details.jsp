...
<div class="container">
   ...
   <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="${pageContext.request.contextPath}/resources/images/img10.jpg" />
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                    <!-- Datos del vendedor y titulo del producto -->
                    <h3>Men blue jacket </h3>    
                    ...
                    <h3 style="margin-top:0px;">1500</h3>
                    ...
                    <div class="section" style="padding-bottom:5px;">
                        <h6 class="title-attr"><small>Size Chart</small></h6>    
                         ...
                         <div> 
                        <br> <div class="attr2">30</div>
                         <br> <div class="attr2">32</div>
                          <br> <div class="attr2">38</div>
                        </div> 
                    </div>   
   ...
   <div class="col-xs-9">
                    <ul class="menu-items">
                        ...
                        <li>Men blue jacket</li>
                        
                    </ul>
                    <div style="width:100%;border-top:1px solid silver">
                        <p style="padding:15px;">
                            <small>
                           Stay connected either on the phone or the Web with the jackets from Adidas. this cloths stores precious photos and video and lets you upload them to a cloud or social network at blinding-fast move . With a 17-hour operating life from one charge, this phone allows you keep in touch even on the go. 
