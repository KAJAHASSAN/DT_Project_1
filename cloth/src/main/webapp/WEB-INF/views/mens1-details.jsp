...
<div class="container">
   ...
   <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="${pageContext.request.contextPath}/resources/images/img2.jpg" />
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                    <!-- Datos del vendedor y titulo del producto -->
                    <h3>Men pink casual Shirt </h3>    
                    ...
                    <h3 style="margin-top:0px;">1200</h3>
                    ...
                    <div class="section" style="padding-bottom:5px;">
                        <h6 class="title-attr"><small>Size</small></h6>    
                         ...
                         <div> 
                       <br> <div class="attr2">36</div>
                        <div class="attr2">38</div>
